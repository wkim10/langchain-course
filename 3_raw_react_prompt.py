...
# Delete the JSON schemas. Tools now live inside the prompt as plain text.
...
# Drop tools= from ollama.chat(). The LLM has no idea it's an agent -
...
def run_agent(question: str):
    ...
    for iteration in range(1, MAX_ITERATIONS + 1):
        ...
        # Parse tool calls from raw text with regex - fragile if LLM doesn't allow format.
